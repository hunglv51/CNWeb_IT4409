...
function get_method($object)
{
	...
	if(get_parent_class($object))
	{
		...
		$methods = array_diff($parent_methods, $methods);
	}
	return $methods;
}
//inherited method
function get_inherited_method($object)
{
	$methods = get_class_methods(get_class($object));
	...
	{
		$parent_methods = get_class_methods(get_parent_class($object));
		$methods = array_intersect($parent_methods, $methods);
	}
	return $methods;
}
//super classes
...
function print_object_info($object)
{
	...
	$object_methods = get_method($object);
	if(!count($methods))
	{
		echo "<i>None</i>";
	}
	...
	{
		echo '<p>Inherited methods are in <i>italic</i>.</p>';
